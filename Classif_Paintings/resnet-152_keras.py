...
# -*- coding: utf-8 -*-
"""
Created on Thu Nov  9 16:18:12 2017
...
#        self.beta = self.beta_init(shape, name='{}_beta'.format(self.name))
        # Modified by gonthier suggested by https://github.com/flyyufelix/cnn_finetune/issues/2
...
def resnet152_model(weights_path=None):
    ...
    x_fc_flatten = Flatten()(x_fc)
    x_fc_flatten = Dense(1000, activation='softmax', name='fc1000')(x_fc_flatten)

    model = Model(img_input, x_fc_flatten)
...
def read_dict_imagenet():
    dicts_from_file = []
    with open('imageNet_map.txt','r') as inf:
        for line in inf:
...
if __name__ == '__main__':
  ...
  print("Predicted class:", dict[np.argmax(out)])
