# -*- coding: utf-8 -*-
"""
Created on Mercredi 18 avril 2018 

@author: gonthier

But tester les reseaux entrainees

Problem actuel avec le fait que l API COCO tourne sous python 2....
...
#import _init_paths, time
from tf_faster_rcnn.lib.model.test import test_net
from tf_faster_rcnn.lib.model.config import cfg, cfg_from_file, cfg_from_list
