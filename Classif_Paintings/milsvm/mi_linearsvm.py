...
import inspect
from milsvm.sil import SIL
from sklearn.svm import LinearSVC as SVM
from milsvm.cccp import CCCP
from milsvm.quadprog import IterativeQP, spzeros, speye
from milsvm.kernel import by_name as kernel_by_name
from milsvm.util import partition, BagSplitter, spdiag, rand_convex, slices
...
class miSVM(SIL):
    ...
    def fit(self, bags, y):
        ...
        for rr in range(self.restarts + 1):
            ...
            # Setup SVM and QP
            if self.scale_C:  # TODO comment this 3 lines
