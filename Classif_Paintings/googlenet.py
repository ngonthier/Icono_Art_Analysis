...
def inception_v1_oldTF(weights='imagenet',include_top=True,input_shape= (224, 224, 3)):
    ...
    depth_radius = 5
    input_pad = ZeroPadding2D(padding=(3, 3))(img_input)
    conv1_7x7_s2_pre_relu = Conv2D(64, (7,7), strides=(2,2), padding='valid', activation='linear', 
                                   name='conv2d0_pre_relu', kernel_regularizer=kernel_regularizer, kernel_initializer=kernel_init, bias_initializer=bias_init)(input_pad)
    ...
    conv2_3x3_reduce_pre_relu = Conv2D(64, (1,1), padding='same', activation='linear', name='conv2d1_pre_relu', kernel_regularizer=kernel_regularizer, kernel_initializer=kernel_init, bias_initializer=bias_init)(pool1_norm1)
    conv2_3x3_reduce = Activation('relu',name='conv2d1')(conv2_3x3_reduce_pre_relu)
    conv2_3x3_pre_relu = Conv2D(192, (3,3), padding='same', activation='linear', name='conv2d2_pre_relu', kernel_regularizer=kernel_regularizer, kernel_initializer=kernel_init, bias_initializer=bias_init)(conv2_3x3_reduce)
    ...
    inception_3a_1x1_pre_relu = Conv2D(64, (1,1), padding='same', activation='linear', name='mixed3a_1x1_pre_relu', kernel_regularizer=kernel_regularizer, kernel_initializer=kernel_init, bias_initializer=bias_init)(pool2_3x3_s2)
    #inception_3a_1x1 = Activation('relu',name='mixed3a_1x1')(inception_3a_1x1_pre_relu)
    inception_3a_3x3_reduce_pre_relu = Conv2D(96, (1,1), padding='same', activation='linear', name='mixed3a_3x3_bottleneck_pre_relu', kernel_regularizer=kernel_regularizer, kernel_initializer=kernel_init, bias_initializer=bias_init)(pool2_3x3_s2)
    inception_3a_3x3_reduce = Activation('relu',name='mixed3a_3x3_bottleneck')(inception_3a_3x3_reduce_pre_relu)
    inception_3a_3x3_pad = ZeroPadding2D(padding=(1, 1))(inception_3a_3x3_reduce)
    inception_3a_3x3_pre_relu = Conv2D(128, (3,3), padding='valid', activation='linear', name='mixed3a_3x3_pre_relu', kernel_regularizer=kernel_regularizer, kernel_initializer=kernel_init, bias_initializer=bias_init)(inception_3a_3x3_pad)
    #inception_3a_3x3 = Activation('relu',name='mixed3a_3x3')(inception_3a_3x3_pre_relu)
    inception_3a_5x5_reduce_pre_relu = Conv2D(16, (1,1), padding='same', activation='linear', name='mixed3a_5x5_bottleneck_pre_relu', kernel_regularizer=kernel_regularizer, kernel_initializer=kernel_init, bias_initializer=bias_init)(pool2_3x3_s2)
    inception_3a_5x5_reduce = Activation('relu',name='mixed3a_5x5_bottleneck')(inception_3a_5x5_reduce_pre_relu)
    inception_3a_5x5_pad = ZeroPadding2D(padding=(2, 2))(inception_3a_5x5_reduce)
    inception_3a_5x5_pre_relu = Conv2D(32, (5,5), padding='valid', activation='linear', name='mixed3a_5x5_pre_relu', kernel_regularizer=kernel_regularizer, kernel_initializer=kernel_init, bias_initializer=bias_init)(inception_3a_5x5_pad)
    ...
    inception_3a_pool_proj_pre_relu = Conv2D(32, (1,1), padding='same', activation='linear', name='mixed3a_pool_reduce_pre_relu', kernel_regularizer=kernel_regularizer, kernel_initializer=kernel_init, bias_initializer=bias_init)(inception_3a_pool)
    ...
    inception_3b_1x1_pre_relu = Conv2D(128, (1,1), padding='same', activation='linear', name='mixed3b_1x1_pre_relu', kernel_regularizer=kernel_regularizer, kernel_initializer=kernel_init, bias_initializer=bias_init)(inception_3a_output)
    #inception_3b_1x1 = Activation('relu',name='mixed3b_1x1')(inception_3b_1x1_pre_relu)
    inception_3b_3x3_reduce_pre_relu = Conv2D(128, (1,1), padding='same', activation='linear', name='mixed3b_3x3_bottleneck_pre_relu', kernel_regularizer=kernel_regularizer, kernel_initializer=kernel_init, bias_initializer=bias_init)(inception_3a_output)
    inception_3b_3x3_reduce = Activation('relu',name='mixed3b_3x3_bottleneck')(inception_3b_3x3_reduce_pre_relu)
    inception_3b_3x3_pad = ZeroPadding2D(padding=(1, 1))(inception_3b_3x3_reduce)
    inception_3b_3x3_pre_relu = Conv2D(192, (3,3), padding='valid', activation='linear', name='mixed3b_3x3_pre_relu', kernel_regularizer=kernel_regularizer, kernel_initializer=kernel_init, bias_initializer=bias_init)(inception_3b_3x3_pad)
    #inception_3b_3x3 = Activation('relu',name='mixed3b_3x3')(inception_3b_3x3_pre_relu)
    inception_3b_5x5_reduce_pre_relu = Conv2D(32, (1,1), padding='same', activation='linear', name='mixed3b_5x5_bottleneck_pre_relu', kernel_regularizer=kernel_regularizer, kernel_initializer=kernel_init, bias_initializer=bias_init)(inception_3a_output)
    inception_3b_5x5_reduce = Activation('relu',name='mixed3b_5x5_bottleneck')(inception_3b_5x5_reduce_pre_relu)
    inception_3b_5x5_pad = ZeroPadding2D(padding=(2, 2))(inception_3b_5x5_reduce)
    inception_3b_5x5_pre_relu = Conv2D(96, (5,5), padding='valid', activation='linear', name='mixed3b_5x5_pre_relu', kernel_regularizer=kernel_regularizer, kernel_initializer=kernel_init, bias_initializer=bias_init)(inception_3b_5x5_pad)
    ...
    inception_3b_pool_proj_pre_relu = Conv2D(64, (1,1), padding='same', activation='linear', name='mixed3b_pool_reduce_pre_relu', kernel_regularizer=kernel_regularizer, kernel_initializer=kernel_init, bias_initializer=bias_init)(inception_3b_pool)
    ...
    inception_4a_1x1_pre_relu  = Conv2D(192, (1,1), padding='same', activation='linear', name='mixed4a_1x1_pre_relu', kernel_regularizer=kernel_regularizer, kernel_initializer=kernel_init, bias_initializer=bias_init)(pool3_3x3_s2)
    #inception_4a_1x1 = Activation('relu',name='mixed4a_1x1')(inception_4a_1x1_pre_relu)
    inception_4a_3x3_reduce_pre_relu  = Conv2D(96, (1,1), padding='same', activation='linear', name='mixed4a_3x3_bottleneck_pre_relu', kernel_regularizer=kernel_regularizer, kernel_initializer=kernel_init, bias_initializer=bias_init)(pool3_3x3_s2)
    inception_4a_3x3_reduce = Activation('relu',name='mixed4a_3x3_bottleneck')(inception_4a_3x3_reduce_pre_relu)
    inception_4a_3x3_pad = ZeroPadding2D(padding=(1, 1))(inception_4a_3x3_reduce)
    inception_4a_3x3_pre_relu  = Conv2D(204, (3,3), padding='valid', activation='linear', name='mixed4a_3x3_pre_relu' ,kernel_regularizer=kernel_regularizer, kernel_initializer=kernel_init, bias_initializer=bias_init)(inception_4a_3x3_pad)
    #inception_4a_3x3 = Activation('relu',name='mixed4a_3x3')(inception_4a_3x3_pre_relu)
    inception_4a_5x5_reduce_pre_relu  = Conv2D(16, (1,1), padding='same', activation='linear', name='mixed4a_5x5_bottleneck_pre_relu', kernel_regularizer=kernel_regularizer, kernel_initializer=kernel_init, bias_initializer=bias_init)(pool3_3x3_s2)
    inception_4a_5x5_reduce = Activation('relu',name='mixed4a_5x5_bottleneck')(inception_4a_5x5_reduce_pre_relu)
    inception_4a_5x5_pad = ZeroPadding2D(padding=(2, 2))(inception_4a_5x5_reduce)
    inception_4a_5x5_pre_relu  = Conv2D(48, (5,5), padding='valid', activation='linear', name='mixed4a_5x5_pre_relu', kernel_regularizer=kernel_regularizer, kernel_initializer=kernel_init, bias_initializer=bias_init)(inception_4a_5x5_pad)
    ...
    inception_4a_pool_proj_pre_relu  = Conv2D(64, (1,1), padding='same', activation='linear', name='mixed4a_pool_reduce_pre_relu', kernel_regularizer=kernel_regularizer, kernel_initializer=kernel_init, bias_initializer=bias_init)(inception_4a_pool)
    ...
    loss1_conv_pre_relu = Conv2D(128, (1,1), padding='same', activation='linear', name='head0_bottleneck_pre_relu', kernel_regularizer=kernel_regularizer, kernel_initializer=kernel_init, bias_initializer=bias_init)(loss1_ave_pool)
    loss1_conv = Activation('relu',name='head0_bottleneck')(loss1_conv_pre_relu)
    
    if include_top:
        loss1_flat = Flatten()(loss1_conv)
        loss1_fc_pre_relu = Dense(1024, activation='linear', name='nn0_pre_relu', kernel_regularizer=kernel_regularizer, kernel_initializer=kernel_init, bias_initializer=bias_init)(loss1_flat)
        loss1_fc = Activation('relu',name='nn0')(loss1_fc_pre_relu)
        loss1_drop_fc = Dropout(rate=0.7)(loss1_fc)
        loss1_classifier = Dense(output_classes_num, name='softmax0_pre_activation', kernel_regularizer=kernel_regularizer, kernel_initializer=kernel_init, bias_initializer=bias_init, activation='linear')(loss1_drop_fc)
        loss1_classifier_act = Activation('softmax',name='softname0')(loss1_classifier)

    inception_4b_1x1_pre_relu  = Conv2D(160, (1,1), padding='same', activation='linear', name='mixed4b_1x1_pre_relu', kernel_regularizer=kernel_regularizer, kernel_initializer=kernel_init, bias_initializer=bias_init)(inception_4a_output)
    #inception_4b_1x1 = Activation('relu',name='mixed4b_1x1')(inception_4b_1x1_pre_relu)
    inception_4b_3x3_reduce_pre_relu  = Conv2D(112, (1,1), padding='same', activation='linear', name='mixed4b_3x3_bottleneck_pre_relu', kernel_regularizer=kernel_regularizer, kernel_initializer=kernel_init, bias_initializer=bias_init)(inception_4a_output)
    inception_4b_3x3_reduce = Activation('relu',name='mixed4b_3x3_bottleneck')(inception_4b_3x3_reduce_pre_relu)
    inception_4b_3x3_pad = ZeroPadding2D(padding=(1, 1))(inception_4b_3x3_reduce)
    inception_4b_3x3_pre_relu  = Conv2D(224, (3,3), padding='valid', activation='linear', name='mixed4b_3x3_pre_relu', kernel_regularizer=kernel_regularizer, kernel_initializer=kernel_init, bias_initializer=bias_init)(inception_4b_3x3_pad)
    #inception_4b_3x3 = Activation('relu',name='mixed4b_3x3')(inception_4b_3x3_pre_relu)
    inception_4b_5x5_reduce_pre_relu = Conv2D(24, (1,1), padding='same', activation='linear', name='mixed4b_5x5_bottleneck_pre_relu', kernel_regularizer=kernel_regularizer, kernel_initializer=kernel_init, bias_initializer=bias_init)(inception_4a_output)
    inception_4b_5x5_reduce = Activation('relu',name='mixed4b_5x5_bottleneck')(inception_4b_5x5_reduce_pre_relu)
    inception_4b_5x5_pad = ZeroPadding2D(padding=(2, 2))(inception_4b_5x5_reduce)
    inception_4b_5x5_pre_relu  = Conv2D(64, (5,5), padding='valid', activation='linear', name='mixed4b_5x5_pre_relu', kernel_regularizer=kernel_regularizer, kernel_initializer=kernel_init, bias_initializer=bias_init)(inception_4b_5x5_pad)
    ...
    inception_4b_pool_proj_pre_relu  = Conv2D(64, (1,1), padding='same', activation='linear', name='mixed4b_pool_reduce_pre_relu', kernel_regularizer=kernel_regularizer, kernel_initializer=kernel_init, bias_initializer=bias_init)(inception_4b_pool)
    ...
    inception_4c_1x1_pre_relu  = Conv2D(128, (1,1), padding='same', activation='linear', name='mixed4c_1x1_pre_relu', kernel_regularizer=kernel_regularizer, kernel_initializer=kernel_init, bias_initializer=bias_init)(inception_4b_output)
    #inception_4c_1x1 = Activation('relu',name='mixed4c_1x1')(inception_4c_1x1_pre_relu)
    inception_4c_3x3_reduce_pre_relu  = Conv2D(128, (1,1), padding='same', activation='linear', name='mixed4c_3x3_bottleneck_pre_relu', kernel_regularizer=kernel_regularizer, kernel_initializer=kernel_init, bias_initializer=bias_init)(inception_4b_output)
    inception_4c_3x3_reduce = Activation('relu',name='mixed4c_3x3_bottleneck')(inception_4c_3x3_reduce_pre_relu)
    inception_4c_3x3_pad = ZeroPadding2D(padding=(1, 1))(inception_4c_3x3_reduce)
    inception_4c_3x3_pre_relu  = Conv2D(256, (3,3), padding='valid', activation='linear', name='mixed4c_3x3_pre_relu', kernel_regularizer=kernel_regularizer, kernel_initializer=kernel_init, bias_initializer=bias_init)(inception_4c_3x3_pad)
    #inception_4c_3x3 = Activation('relu',name='mixed4c_3x3')(inception_4c_3x3_pre_relu)
    inception_4c_5x5_reduce_pre_relu  = Conv2D(24, (1,1), padding='same', activation='linear', name='mixed4c_5x5_bottleneck_pre_relu', kernel_regularizer=kernel_regularizer, kernel_initializer=kernel_init, bias_initializer=bias_init)(inception_4b_output)
    inception_4c_5x5_reduce = Activation('relu',name='mixed4c_5x5_bottleneck')(inception_4c_5x5_reduce_pre_relu)
    inception_4c_5x5_pad = ZeroPadding2D(padding=(2, 2))(inception_4c_5x5_reduce)
    inception_4c_5x5_pre_relu  = Conv2D(64, (5,5), padding='valid', activation='linear', name='mixed4c_5x5_pre_relu', kernel_regularizer=kernel_regularizer, kernel_initializer=kernel_init, bias_initializer=bias_init)(inception_4c_5x5_pad)
    ...
    inception_4c_pool_proj_pre_relu  = Conv2D(64, (1,1), padding='same', activation='linear', name='mixed4c_pool_reduce_pre_relu', kernel_regularizer=kernel_regularizer, kernel_initializer=kernel_init, bias_initializer=bias_init)(inception_4c_pool)
    ...
    inception_4d_1x1_pre_relu = Conv2D(112, (1,1), padding='same', activation='linear', name='mixed4d_1x1_pre_relu', kernel_regularizer=kernel_regularizer, kernel_initializer=kernel_init, bias_initializer=bias_init)(inception_4c_output)
    #inception_4d_1x1 =  Activation('relu',name='mixed4d_1x1')(inception_4d_1x1_pre_relu)
    inception_4d_3x3_reduce_pre_relu = Conv2D(144, (1,1), padding='same', activation='linear', name='mixed4d_3x3_bottleneck_pre_relu', kernel_regularizer=kernel_regularizer, kernel_initializer=kernel_init, bias_initializer=bias_init)(inception_4c_output)
    inception_4d_3x3_reduce =  Activation('relu',name='mixed4d_3x3_bottleneck')(inception_4d_3x3_reduce_pre_relu)
    inception_4d_3x3_pad = ZeroPadding2D(padding=(1, 1))(inception_4d_3x3_reduce)
    inception_4d_3x3_pre_relu = Conv2D(288, (3,3), padding='valid', activation='linear', name='mixed4d_3x3_pre_relu', kernel_regularizer=kernel_regularizer, kernel_initializer=kernel_init, bias_initializer=bias_init)(inception_4d_3x3_pad)
    #inception_4d_3x3 =  Activation('relu',name='mixed4d_3x3')(inception_4d_3x3_pre_relu)
    inception_4d_5x5_reduce_pre_relu = Conv2D(32, (1,1), padding='same', activation='linear', name='mixed4d_5x5_bottleneck_pre_relu', kernel_regularizer=kernel_regularizer, kernel_initializer=kernel_init, bias_initializer=bias_init)(inception_4c_output)
    inception_4d_5x5_reduce =  Activation('relu',name='mixed4d_5x5_bottleneck')(inception_4d_5x5_reduce_pre_relu)
    inception_4d_5x5_pad = ZeroPadding2D(padding=(2, 2))(inception_4d_5x5_reduce)
    inception_4d_5x5_pre_relu = Conv2D(64, (5,5), padding='valid', activation='linear', name='mixed4d_5x5_pre_relu', kernel_regularizer=kernel_regularizer, kernel_initializer=kernel_init, bias_initializer=bias_init)(inception_4d_5x5_pad)
    ...
    inception_4d_pool_proj_pre_relu = Conv2D(64, (1,1), padding='same', activation='linear', name='mixed4d_pool_reduce_pre_relu', kernel_regularizer=kernel_regularizer, kernel_initializer=kernel_init, bias_initializer=bias_init)(inception_4d_pool)
    ...
    loss2_conv_pre_relu = Conv2D(128, (1,1), padding='same', activation='linear', name='head1_bottleneck_pre_relu', kernel_regularizer=kernel_regularizer, kernel_initializer=kernel_init, bias_initializer=bias_init)(loss2_ave_pool)
    loss2_conv = Activation('relu',name='head1_bottleneck')(loss2_conv_pre_relu)
    
    if include_top:
        loss2_flat = Flatten()(loss2_conv)
        loss2_fc_pre_relu = Dense(1024, activation='linear', name='nn1_pre_relu', kernel_regularizer=kernel_regularizer, kernel_initializer=kernel_init, bias_initializer=bias_init)(loss2_flat)
        loss2_fc = Activation('relu',name='nn1')(loss2_fc_pre_relu)
        loss2_drop_fc = Dropout(rate=0.7)(loss2_fc)
        loss2_classifier = Dense(output_classes_num, name='softmax1_pre_activation', kernel_regularizer=kernel_regularizer, kernel_initializer=kernel_init, bias_initializer=bias_init, activation='linear')(loss2_drop_fc)
        loss2_classifier_act = Activation('softmax',name='softname1')(loss2_classifier)

    inception_4e_1x1_pre_relu = Conv2D(256, (1,1), padding='same', activation='linear', name='mixed4e_1x1_pre_relu', kernel_regularizer=kernel_regularizer, kernel_initializer=kernel_init, bias_initializer=bias_init)(inception_4d_output)
    #inception_4e_1x1 = Activation('relu',name='mixed4e_1x1')(inception_4e_1x1_pre_relu)
    inception_4e_3x3_reduce_pre_relu = Conv2D(160, (1,1), padding='same', activation='linear', name='mixed4e_3x3_bottleneck_pre_relu', kernel_regularizer=kernel_regularizer, kernel_initializer=kernel_init, bias_initializer=bias_init)(inception_4d_output)
    inception_4e_3x3_reduce = Activation('relu',name='mixed4e_3x3_bottleneck')(inception_4e_3x3_reduce_pre_relu)
    inception_4e_3x3_pad = ZeroPadding2D(padding=(1, 1))(inception_4e_3x3_reduce)
    inception_4e_3x3_pre_relu = Conv2D(320, (3,3), padding='valid', activation='linear', name='mixed4e_3x3_pre_relu', kernel_regularizer=kernel_regularizer, kernel_initializer=kernel_init, bias_initializer=bias_init)(inception_4e_3x3_pad)
    #inception_4e_3x3 =Activation('relu',name='mixed4e_3x3')(inception_4e_3x3_pre_relu)
    inception_4e_5x5_reduce_pre_relu = Conv2D(32, (1,1), padding='same', activation='linear', name='mixed4e_5x5_bottleneck_pre_relu', kernel_regularizer=kernel_regularizer, kernel_initializer=kernel_init, bias_initializer=bias_init)(inception_4d_output)
    inception_4e_5x5_reduce =Activation('relu',name='mixed4e_5x5_bottleneck')(inception_4e_5x5_reduce_pre_relu)
    inception_4e_5x5_pad = ZeroPadding2D(padding=(2, 2))(inception_4e_5x5_reduce)
    inception_4e_5x5_pre_relu = Conv2D(128, (5,5), padding='valid', activation='linear', name='mixed4e_5x5_pre_relu', kernel_regularizer=kernel_regularizer, kernel_initializer=kernel_init, bias_initializer=bias_init)(inception_4e_5x5_pad)
    ...
    inception_4e_pool_proj_pre_relu = Conv2D(128, (1,1), padding='same', activation='linear', name='mixed4e_pool_reduce_pre_relu', kernel_regularizer=kernel_regularizer, kernel_initializer=kernel_init, bias_initializer=bias_init)(inception_4e_pool)
    ...
    inception_5a_1x1_pre_relu = Conv2D(256, (1,1), padding='same', activation='linear', name='mixed5a_1x1_pre_relu', kernel_regularizer=kernel_regularizer, kernel_initializer=kernel_init, bias_initializer=bias_init)(pool4_3x3_s2)
    #inception_5a_1x1 = Activation('relu',name='mixed5a_1x1')(inception_5a_1x1_pre_relu)
    inception_5a_3x3_reduce_pre_relu = Conv2D(160, (1,1), padding='same', activation='linear', name='mixed5a_3x3_bottleneck_pre_relu', kernel_regularizer=kernel_regularizer, kernel_initializer=kernel_init, bias_initializer=bias_init)(pool4_3x3_s2)
    inception_5a_3x3_reduce = Activation('relu',name='mixed5a_3x3_bottleneck')(inception_5a_3x3_reduce_pre_relu)
    inception_5a_3x3_pad = ZeroPadding2D(padding=(1, 1))(inception_5a_3x3_reduce)
    inception_5a_3x3_pre_relu = Conv2D(320, (3,3), padding='valid', activation='linear', name='mixed5a_3x3_pre_relu', kernel_regularizer=kernel_regularizer, kernel_initializer=kernel_init, bias_initializer=bias_init)(inception_5a_3x3_pad)
    #inception_5a_3x3 = Activation('relu',name='mixed5a_3x3')(inception_5a_3x3_pre_relu)
    inception_5a_5x5_reduce_pre_relu = Conv2D(48, (1,1), padding='same', activation='linear', name='mixed5a_5x5_bottleneck_pre_relu', kernel_regularizer=kernel_regularizer, kernel_initializer=kernel_init, bias_initializer=bias_init)(pool4_3x3_s2)
    inception_5a_5x5_reduce = Activation('relu',name='mixed5a_5x5_bottleneck')(inception_5a_5x5_reduce_pre_relu)
    inception_5a_5x5_pad = ZeroPadding2D(padding=(2, 2))(inception_5a_5x5_reduce)
    inception_5a_5x5_pre_relu = Conv2D(128, (5,5), padding='valid', activation='linear', name='mixed5a_5x5_pre_relu', kernel_regularizer=kernel_regularizer, kernel_initializer=kernel_init, bias_initializer=bias_init)(inception_5a_5x5_pad)
    ...
    inception_5a_pool_proj_pre_relu = Conv2D(128, (1,1), padding='same', activation='linear', name='mixed5a_pool_reduce_pre_relu', kernel_regularizer=kernel_regularizer, kernel_initializer=kernel_init, bias_initializer=bias_init)(inception_5a_pool)
    ...
    inception_5b_1x1_pre_relu = Conv2D(384, (1,1), padding='same', activation='linear', name='mixed5b_1x1_pre_relu', kernel_regularizer=kernel_regularizer, kernel_initializer=kernel_init, bias_initializer=bias_init)(inception_5a_output)
    #inception_5b_1x1 = Activation('relu',name='mixed5b_1x1')(inception_5b_1x1_pre_relu)
    inception_5b_3x3_reduce_pre_relu = Conv2D(192, (1,1), padding='same', activation='linear', name='mixed5b_3x3_bottleneck_pre_relu', kernel_regularizer=kernel_regularizer, kernel_initializer=kernel_init, bias_initializer=bias_init)(inception_5a_output)
    inception_5b_3x3_reduce = Activation('relu',name='mixed5b_3x3_bottleneck')(inception_5b_3x3_reduce_pre_relu)
    inception_5b_3x3_pad = ZeroPadding2D(padding=(1, 1))(inception_5b_3x3_reduce)
    inception_5b_3x3_pre_relu = Conv2D(384, (3,3), padding='valid', activation='linear', name='mixed5b_3x3_pre_relu', kernel_regularizer=kernel_regularizer, kernel_initializer=kernel_init, bias_initializer=bias_init)(inception_5b_3x3_pad)
    #inception_5b_3x3 = Activation('relu',name='mixed5b_3x3')(inception_5b_3x3_pre_relu)
    inception_5b_5x5_reduce_pre_relu = Conv2D(48, (1,1), padding='same', activation='linear', name='mixed5b_5x5_bottleneck_pre_relu', kernel_regularizer=kernel_regularizer, kernel_initializer=kernel_init, bias_initializer=bias_init)(inception_5a_output)
    inception_5b_5x5_reduce = Activation('relu',name='mixed5b_5x5_bottleneck')(inception_5b_5x5_reduce_pre_relu)
    inception_5b_5x5_pad = ZeroPadding2D(padding=(2, 2))(inception_5b_5x5_reduce)
    inception_5b_5x5_pre_relu = Conv2D(128, (5,5), padding='valid', activation='linear', name='mixed5b_5x5_pre_relu', kernel_regularizer=kernel_regularizer, kernel_initializer=kernel_init, bias_initializer=bias_init)(inception_5b_5x5_pad)
    ...
    inception_5b_pool_proj_pre_relu = Conv2D(128, (1,1), padding='same', activation='linear', name='mixed5b_pool_reduce_pre_relu', kernel_regularizer=kernel_regularizer, kernel_initializer=kernel_init, bias_initializer=bias_init)(inception_5b_pool)
...
def inception_v1_oldTF_all_relu(weights=None,include_top=True):
    ...
    input_pad = ZeroPadding2D(padding=(3, 3))(img_input)
    conv1_7x7_s2_pre_relu = Conv2D(64, (7,7), strides=(2,2), padding='valid', activation='linear', name='conv2d0_pre_relu',
                                   kernel_regularizer=kernel_regularizer, kernel_initializer=kernel_init, bias_initializer=bias_init)(input_pad)
    conv1_7x7_s2 = Activation('relu',name='conv2d0')(conv1_7x7_s2_pre_relu)
    conv1_zero_pad = ZeroPadding2D(padding=(1, 1))(conv1_7x7_s2)
    pool1_helper = PoolHelper()(conv1_zero_pad)
    pool1_3x3_s2 = MaxPooling2D(pool_size=(3,3), strides=(2,2), padding='valid', name='maxpool0')(pool1_helper)
