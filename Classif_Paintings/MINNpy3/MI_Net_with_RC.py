...
def MI_Net_with_RC_WSOD(dataset,weight_decay=0.005,pooling_mode='max',init_lr=0.001,momentum=0.9,
                max_epoch=20):
    """Train and evaluate on MI-Net with residual connection.
    Parameters
    -----------------
    ...
    # fully-connected
    fc1 = Dense(128, activation='relu', kernel_regularizer=l2(weight_decay))(data_input)
    fc2 = Dense(128, activation='relu', kernel_regularizer=l2(weight_decay))(fc1)
    fc3 = Dense(128, activation='relu', kernel_regularizer=l2(weight_decay))(fc2)
    ...
    # residual connection
    rc1 = RC_block(pooling_mode=pooling_mode, name='rc1')(dropout1)
    rc2 = RC_block(pooling_mode=pooling_mode, name='rc2')(dropout2)
    rc3 = RC_block(pooling_mode=pooling_mode, name='rc3')(dropout3)
